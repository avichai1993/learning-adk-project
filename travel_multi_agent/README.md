...
- `uvicorn travel_multi_agent.flight_agent:a2a_app --host localhost --port 8011`
- `uvicorn travel_multi_agent.hotel_agent:a2a_app --host localhost --port 8012`
- `uvicorn travel_multi_agent.itinerary_agent:a2a_app --host localhost --port 8013`
